# -*- coding: utf-8 -*-
"""
Created on Thu Aug 12 13:38:48 2021
...
def get_filters():
    ...
    while city not in CITY_DATA.keys():
        city=input("Please choose the city you want (Chicago - New york city - Washington):").lower()
        if city not in CITY_DATA.keys():
            print("\nInvalid input, Please check your input again.")
        else:
            print("\nYou've chosen {}.".format(city.title()))
            print('-'*25)
    ...
    while month not in MONTH_DATA.keys():
        month=input("Please choose the desired month from January to June (you can also choose all months by typing all):").lower()

        if month not in MONTH_DATA.keys():
            print("\nInvalid input, Please check your input again.")
        else:
            print("\nYou've chosen {}.".format(month))
            print('-'*25)
    ...
    while day not in DAYS:
        day = input("Please choose the day you want from Monday to Sunday (you can also choose all days by typing all):").lower()
       
        if day not in DAYS:
            print("\nInvalid input, Please check your input again.")
        else:
            print("\nYou've chosen {}.".format(day.title()))
            print('-'*25)
